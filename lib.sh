...
create_vmess() {
  ...
  tg_notify "🆕 <b>Akun VMess Baru</b>

Username: <code>$username</code>
UUID: <code>$uuid</code>
Domain: <code>$(get_domain)</code>
Expired: <code>$exp</code> ($days hari)
Limit Device/IP: <code>$(fmt_limit "$ip_limit")</code>
Limit Kuota: <code>$(fmt_quota "$quota_mb")</code>" "create"
...
create_trojan() {
  ...
  tg_notify "🆕 <b>Akun Trojan Baru</b>
...
create_ss() {
  ...
  tg_notify "🆕 <b>Akun Shadowsocks Baru</b>
...
create_ssh() {
  ...
  tg_notify "🆕 <b>Akun SSH/SSH-WS Baru</b>

Username: <code>$username</code>
Password: <code>$password</code>
Domain: <code>$(get_domain)</code>
Expired: <code>$exp</code> ($days hari)
Limit Device/IP: <code>$(fmt_limit "$session_limit")</code>
Limit Kuota: <code>$(fmt_quota "$quota_mb")</code>" "create"
